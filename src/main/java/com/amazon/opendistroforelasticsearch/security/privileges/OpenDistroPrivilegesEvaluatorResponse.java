...
public class OpenDistroPrivilegesEvaluatorResponse implements PrivilegesEvaluatorResponse {
    ...
    public OpenDistroPrivilegesEvaluatorResponse markComplete() {
        this.state = PrivilegesEvaluatorResponseState.COMPLETE;
        return this;
    }

    public OpenDistroPrivilegesEvaluatorResponse markPending() {
